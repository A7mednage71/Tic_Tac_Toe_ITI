...
public class AppConstants {
    ...
    public static final String PATH_REGISTER = "/com/mycompany/finalprojectclient/register.fxml";

    public static final String PATH_HOME = "/com/mycompany/finalprojectclient/Home.fxml";

    public static final String PATH_GAME_BOARD = "/com/mycompany/finalprojectclient/Board.fxml";
